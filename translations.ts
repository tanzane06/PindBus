export const translations: { [key: string]: { [key: string]: string } } = {
  en: {
    ...
    'home_no_route_found': 'No Direct Route Found',
    'home_no_route_desc': 'There are no direct buses available between the selected stops.',
    'home_find_your_route': 'Find Your Route',
    'home_find_your_route_desc': 'Select a boarding and destination stop to see available routes and ticket prices.',
    'ticket_price': 'Ticket Price',
    'delay_info': 'Delayed: {reason}',
    'available_routes': 'Available Routes',
    'next_bus_eta': 'Next bus in {eta} min',
    'no_live_bus_data': 'No live bus data',
  ...
  pa: {
    ...
    'home_no_route_found': 'ਕੋਈ ਸਿੱਧਾ ਰੂਟ ਨਹੀਂ ਮਿਲਿਆ',
    'home_no_route_desc': 'ਚੁਣੇ ਗਏ ਸਟਾਪਾਂ ਵਿਚਕਾਰ ਕੋਈ ਸਿੱਧੀ ਬੱਸ ਉਪਲਬਧ ਨਹੀਂ ਹੈ।',
    'home_find_your_route': 'ਆਪਣਾ ਰੂਟ ਲੱਭੋ',
    'home_find_your_route_desc': 'ਉਪਲਬਧ ਰੂਟਾਂ ਅਤੇ ਟਿਕਟ ਦੀਆਂ ਕੀਮਤਾਂ ਦੇਖਣ ਲਈ ਇੱਕ ਬੋਰਡਿੰਗ ਅਤੇ ਮੰਜ਼ਿਲ ਸਟਾਪ ਚੁਣੋ।',
    'ticket_price': 'ਟਿਕਟ ਦੀ ਕੀਮਤ',
    'delay_info': 'ਦੇਰੀ: {reason}',
    'available_routes': 'ਉਪਲਬਧ ਰੂਟ',
    'next_bus_eta': 'ਅਗਲੀ ਬੱਸ {eta} ਮਿੰਟ ਵਿੱਚ',
    'no_live_bus_data': 'ਕੋਈ ਲਾਈਵ ਬੱਸ ਡਾਟਾ ਨਹੀਂ',
